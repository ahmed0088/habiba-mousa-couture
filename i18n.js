...
const I18N = {
  ar: {
    ...
    admin_video_url_label: "رابط الفيديو (يوتيوب أو Vimeo)",
    admin_video_url_placeholder: "الصقي رابط يوتيوب أو Vimeo هنا",
    admin_video_url_hint: "الصقي رابط عادي من يوتيوب أو Vimeo — هنحوّله تلقائي لتشغيل مباشر في الموقع.",
  ...
  en: {
    ...
    admin_video_url_label: "Video link (YouTube or Vimeo)",
    admin_video_url_placeholder: "Paste a YouTube or Vimeo link here",
    admin_video_url_hint: "Paste a normal YouTube or Vimeo link — it'll be converted automatically to play directly on the site.",
