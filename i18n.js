...
const I18N = {
  ar: {
    ...
    admin_staff_intro_html: "اكتبي الإيميل والاسم والصلاحية — هيتم إنشاء حساب الدخول فورًا، وهيوصله إيميل عشان يعمل باسورد.",
    admin_staff_email: "إيميل الموظف",
    ...
    admin_staff_creating: "جاري الإضافة…",
    admin_th_name: "الاسم",
    ...
    admin_staff_note: "تمت إضافة الموظف — هيوصله إيميل عشان يعمل باسورد.",
    admin_staff_note_no_email: "تمت إضافة الموظف، بس إيميل الإعداد ما اتبعتش — قولّه يستخدم \"نسيت كلمة السر\" في شاشة الدخول.",
  ...
  en: {
    ...
    admin_staff_intro_html: "Enter their email, name, and role — they'll instantly get dashboard access and an email to set their password.",
    admin_staff_email: "Staff email",
    ...
    admin_staff_note: "Staff member added — they'll receive an email to set their password.",
    admin_staff_note_no_email: "Staff member added, but the setup email couldn't be sent — ask them to use \"Forgot password\" on the sign-in screen.",
