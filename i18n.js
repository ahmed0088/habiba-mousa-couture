...
const I18N = {
  ar: {
    ...
    filter_sale: "✦ عروض",
    filter_ready_stock: "📦 جاهز للشحن",
    filter_favorites: "♥ المفضلة",
    filter_group_collections: "الكولكشن:",
    ...
    empty_state_favorites: "لسه مضفتيش حاجة للمفضلة — دوسي على القلب في أي قطعة عشان تحفظيها هنا.",
    ...
    submit_success_title: "تم إرسال طلبك!",
    account_signin_success_title: "أهلاً بيكِ!",
    account_signin_success_message: "تم تسجيل الدخول بنجاح.",
    account_signup_success_title: "تم إنشاء حسابك!",
    account_signup_success_message: "أهلاً بيكِ في حبيبه موسي.",
    submit_success_close: "تمام",
    submit_error: "حصلت مشكلة وإحنا بنبعت الطلب. جربي تاني أو كلمينا على واتساب.",

    // Client self-service edit/cancel (only while status is new/contacted)
    edit_request_modal_title: "عدّلي طلبك",
    edit_request_save_btn: "حفظ التعديلات",
    edit_request_success_title: "تم حفظ التعديلات!",
    edit_request_success_message: "اتحدثت بيانات طلبك بنجاح.",
    edit_request_error: "معرفناش نحفظ التعديلات. جربي تاني أو كلمينا على واتساب.",
    my_requests_edit_btn: "تعديل",
    my_requests_cancel_btn: "إلغاء الطلب",
    my_requests_cancel_confirm: "تلغي الطلب ده؟ الإجراء ده مش هينفع ترجعي فيه.",
    my_requests_cancel_success: "تم إلغاء الطلب.",
    my_requests_cancel_error: "معرفناش نلغي الطلب. جربي تاني أو كلمينا على واتساب.",
    ...
    cart_added_toast: "تمت الإضافة للعربة!",
    cart_quick_add: "أضيفي للعربة",
    cart_add_out_of_stock: "الكمية دي مش متوفرة في المقاس/اللون ده.",
    cart_title: "عربة التسوق",
    cart_empty: "عربتك فاضية — ضيفي قطعة من الكولكشن.",
    cart_remove: "إزالة",
    cart_checkout: "إرسال كل الطلبات",
    cart_clear: "إفراغ العربة",
    cart_clear_confirm: "تفريغ العربة؟ هتتشال كل القطع اللي ضفتيها.",
    cart_checkout_title: "تأكيد الطلب",
    cart_checkout_summary: "بتبعتي طلب لـ {count} قطعة سوا.",
    cart_notes_label: "ملاحظات على الطلب كله",
    cart_submit_btn: "إرسال الطلبات",
    ...
    admin_nav_categories: "الأنواع",
    admin_add_category: "+ نوع جديد",
    admin_create_category: "إنشاء النوع",
    admin_category_name: "الاسم",
    admin_categories_intro: "أنواع القطع اللي العميلة تقدر تفلتر بيها — زي فستان، عباية، بنطلون. خليه مختلف عن الكولكشنات (اللي بتبقى موسمية).",
    admin_categories_empty: "لسه مفيش أنواع — ضيفي الأنواع اللي عايزة تظهر للعميلة.",
    admin_nav_collections: "الكولكشنات",
    admin_nav_videos: "الفيديوهات",
    admin_videos_title: "فيديوهات المعرض",
    admin_add_video: "+ فيديو جديد",
    admin_edit_video: "تعديل الفيديو",
    admin_video_title_label: "عنوان الفيديو (اختياري)",
    admin_video_url_label: "رابط الفيديو (يوتيوب، Vimeo، أو رابط فيديو مباشر)",
    admin_video_url_placeholder: "الصقي رابط يوتيوب، Vimeo، أو رابط فيديو (.mp4) مباشر",
    admin_video_url_hint: "الصقي رابط يوتيوب أو Vimeo عادي، أو رابط فيديو مباشر (.mp4/.webm/.mov) — هنحوّله تلقائي لتشغيل مباشر في الموقع.",
    admin_video_url_invalid: "الرابط ده مش من يوتيوب أو Vimeo. جربي تلصقي رابط الفيديو تاني.",
    admin_save_video: "حفظ الفيديو",
    admin_videos_empty: "لسه مفيش فيديوهات — ضيفي رابط فيديو يوتيوب أو Vimeo عشان يظهر في الموقع.",
    admin_video_delete_confirm: "تمسحي الفيديو ده؟",
    ...
    admin_stat_multi_orders: "🛍 طلبات متعددة القطع",
    admin_stat_low_stock: "⚠️ مخزون قليل أو خالص",
    admin_stat_avg_amount: "💰 متوسط المبلغ المُحصّل",
    admin_stat_total_amount: "💵 إجمالي المبلغ المُحصّل",
    admin_stat_new_requests_desc: "الطلبات اللي لسه ما اتصلناش بصاحبتها. دوسي عليها عشان تشوفيها.",
    admin_stat_total_requests_desc: "كل الطلبات اللي اتبعتت من الأول، من جديدة لحد اتسلمت أو اتلغت.",
    admin_stat_active_products_desc: "القطع اللي ظاهرة دلوقتي للعميلات في الموقع.",
    admin_stat_active_collections_desc: "الكولكشنات الفعّالة اللي ظاهرة للعميلات دلوقتي.",
    admin_stat_multi_orders_desc: "الطلبات اللي كانت أكتر من قطعة واحدة في نفس السلة.",
    admin_stat_low_stock_desc: "القطع الجاهزة اللي مخزونها 3 أو أقل — يا وقتها تجهزي كمية جديدة.",
    admin_stat_avg_amount_desc: "متوسط المبلغ المكتوب في الطلبات اللي اتسلمت. اكتبي المبلغ في تفاصيل أي طلب بعد ما يتسلم عشان يتحسب هنا.",
    admin_stat_total_amount_desc: "إجمالي كل المبالغ المكتوبة في الطلبات اللي اتسلمت.",
    admin_filter_multi_orders: "بيتعرض: طلبات متعددة القطع بس",
    admin_filter_active_products: "بيتعرض: منتجات فعّالة بس",
    admin_filter_low_stock: "بيتعرض: مخزون قليل أو خالص بس",
    admin_amount_collected_label: "المبلغ المُحصّل (جنيه)",
    admin_amount_collected_placeholder: "مثال: 2500",
    admin_amount_save_btn: "حفظ المبلغ",
    admin_amount_saved: "تم حفظ المبلغ.",
    admin_amount_save_error: "معرفناش نحفظ المبلغ. جربي تاني.",
    admin_amount_collected_prompt: "قد إيه اتحصل من الطلب ده؟ (بالجنيه) — سيبيه فاضي لو لسه مش عارفة.",
    admin_amount_order_total_suffix: "إجمالي الطلب",
    admin_back_to_dashboard: "الرئيسية",
    admin_settings_inventory: "المخزون",
    admin_settings_low_stock_threshold: "حد المخزون القليل",
    admin_settings_low_stock_note: "القطع اللي مخزونها يوصل للرقم ده أو أقل هياخد علامة \"مخزون قليل\". حطي 0 عشان تقفلي التنبيه ده خالص.",
    admin_activity_title: "سجل النشاط",
    admin_activity_empty: "لسه مفيش نشاط.",
    admin_activity_filter_action: "النوع",
    admin_activity_filter_actor: "الموظف",
    admin_activity_filter_all_actions: "كل الأنواع",
    admin_activity_filter_all_staff: "كل الموظفين",
    admin_activity_filter_from: "من تاريخ",
    admin_activity_filter_to: "لتاريخ",
    ...
    admin_copy_shipping_btn: "نسخ",
    admin_copy_shipping_success: "اتنسخت بيانات الشحن!",
    admin_copy_generic_success: "اتنسخ!",
    admin_copy_click_hint: "دوسي عشان تنسخي",
    admin_copy_label_name: "الاسم",
    admin_copy_label_phone: "الموبايل",
    admin_copy_label_address: "العنوان",
    admin_copy_label_piece: "القطعة",
    admin_copy_label_variant: "المقاس/اللون",
    admin_copy_label_order: "رقم الطلب",
    ...
    admin_p_collection_label: "الكولكشن",
    admin_p_collection_hint: "(اختياري، موسمي)",
    ...
    admin_p_availability: "التوفر",
    admin_p_availability_made: "تفصيل حسب الطلب",
    admin_p_availability_ready: "جاهز للشحن — متوفر دلوقتي",
    admin_p_variants: "المقاسات والألوان المتوفرة (جاهزة دلوقتي)",
    admin_p_variants_note: "سيبي المقاس أو اللون فاضي لو القطعة مش بتتنوع — بس حددي عدد القطع المتوفرة.",
    admin_p_variant_add: "+ ضيفي مقاس/لون",
    ...
    admin_cancel: "إلغاء",
    admin_save: "حفظ",
    admin_my_profile: "✎ عدّلي بياناتك",
    ...
    admin_staff_intro_html: "اكتبي إيميل شخص عنده حساب عميل على الموقع بالفعل — هنبحث عنه، ولو لقيناه هنديله صلاحية الدخول للوحة التحكم على طول. لو لسه معملش حساب، اطلبي منه يعمل حساب على الموقع الأول.",
    ...
    my_requests_multi_item: "جزء من طلب من {count} قطع",
    my_requests_group_label: "طلب من {count} قطع",
    my_account_title: "معلوماتي",
    my_account_intro: "عدّلي بياناتك هنا عشان تتملى تلقائي في أي طلب جديد.",
    my_account_save: "حفظ بياناتي",
    my_account_saved: "تم الحفظ.",
    my_account_error: "معرفناش نحفظ بياناتك. جربي تاني.",
    ...
    detail_cta_order: "اطلبي القطعة دي",
    detail_back: "→ رجوع",
    detail_img_prev: "الصورة اللي قبلها",
    detail_img_next: "الصورة اللي بعدها",
    sale_badge: "خصم",
    ready_badge: "جاهز للشحن",
    sold_out_label: "نفدت الكمية",
    stock_left_label: "متبقي {count} بس",
    in_cart_badge: "كله في عربتك",
    label_size: "المقاس",
    label_color: "اللون",
    ...
    location_optional_note: "اختياري: اكتبي العنوان أو استخدمي أحد الخيارين تحت — الموقع مش لازم يتطابق مع اللي مكتوب فوق.",
    pick_map_btn: "🗺️ حددي دبوس على الخريطة",
    map_pin_hint: "دوسي على الخريطة أو اسحبي الدبوس لتحديد موقعك بالظبط.",
    label_material: "نوع الخامة",
    material_silk: "حرير",
  ...
  en: {
    ...
    hero_title_html: "Made to be <em>yours</em><br/>alone — never off a rack.",
    ...
    filter_sale: "✦ On Sale",
    filter_ready_stock: "📦 Ready to Ship",
    filter_favorites: "♥ Favorites",
    filter_group_collections: "Collection:",
    ...
    empty_state_favorites: "You haven't liked any pieces yet — tap the heart on a piece to save it here.",
    ...
    submit_success_title: "Request sent!",
    account_signin_success_title: "Welcome back!",
    account_signin_success_message: "You've signed in successfully.",
    account_signup_success_title: "Account created!",
    ...
    // Client self-service edit/cancel (only while status is new/contacted)
    edit_request_modal_title: "Edit your request",
    edit_request_save_btn: "Save changes",
    edit_request_success_title: "Changes saved!",
    edit_request_success_message: "Your request has been updated.",
    edit_request_error: "Couldn't save your changes. Please try again or reach us on WhatsApp.",
    my_requests_edit_btn: "Edit",
    my_requests_cancel_btn: "Cancel order",
    my_requests_cancel_confirm: "Cancel this order? This can't be undone.",
    my_requests_cancel_success: "Order cancelled.",
    my_requests_cancel_error: "Couldn't cancel the order. Please try again or reach us on WhatsApp.",
    ...
    cart_quick_add: "Add to Cart",
    cart_add_out_of_stock: "That size/color isn't available in this quantity.",
    cart_title: "Your Cart",
    cart_empty: "Your cart is empty — add a piece from the collection.",
    cart_remove: "Remove",
    cart_checkout: "Send All Requests",
    cart_clear: "Empty Cart",
    cart_clear_confirm: "Empty your cart? This removes everything you've added.",
    cart_checkout_title: "Confirm Your Order",
    cart_checkout_summary: "Sending one request for {count} pieces together.",
    cart_notes_label: "Notes for the whole order",
    cart_submit_btn: "Send Requests",
    ...
    admin_add_category: "+ New Category",
    admin_create_category: "Create Category",
    admin_category_name: "Name",
    admin_categories_intro: "Garment types clients can filter by — e.g. Dress, Abaya, Pants. Keep this list distinct from Collections (seasonal drops).",
    admin_categories_empty: "No categories yet — add the garment types clients can filter by.",
    admin_nav_collections: "Collections",
    admin_nav_videos: "Videos",
    admin_videos_title: "Gallery Videos",
    admin_add_video: "+ Add Video",
    admin_edit_video: "Edit Video",
    admin_video_title_label: "Video title (optional)",
    admin_video_url_label: "Video link (YouTube, Vimeo, or a direct video link)",
    admin_video_url_placeholder: "Paste a YouTube, Vimeo, or direct video (.mp4) link",
    admin_video_url_hint: "Paste a normal YouTube or Vimeo link, or a direct video file link (.mp4/.webm/.mov) — it'll be converted automatically to play directly on the site.",
    admin_video_url_invalid: "That link isn't from YouTube or Vimeo. Try pasting the video link again.",
    admin_save_video: "Save Video",
    admin_videos_empty: "No videos yet — add a YouTube or Vimeo link so it shows on the site.",
    admin_video_delete_confirm: "Delete this video?",
    ...
    admin_stat_multi_orders: "🛍 Multi-Item Orders",
    admin_stat_low_stock: "⚠️ Low / Out of Stock",
    admin_stat_avg_amount: "💰 Avg. Amount Collected",
    admin_stat_total_amount: "💵 Total Collected",
    admin_stat_new_requests_desc: "Requests that came in but haven't been contacted yet. Click to see them.",
    admin_stat_total_requests_desc: "Every request ever submitted, from new to delivered or cancelled.",
    admin_stat_active_products_desc: "Pieces currently visible to clients on the public site.",
    admin_stat_active_collections_desc: "Active collections currently visible to clients.",
    admin_stat_multi_orders_desc: "Requests where the client ordered more than one piece in the same cart.",
    admin_stat_low_stock_desc: "Ready-stock pieces with 3 or fewer left — time to restock.",
    admin_stat_avg_amount_desc: "Average of the amounts entered on delivered orders. Enter the amount on a request's details after it's delivered so it counts here.",
    admin_stat_total_amount_desc: "Sum of every amount entered on delivered orders.",
    admin_filter_multi_orders: "Showing: multi-item orders only",
    admin_filter_active_products: "Showing: active products only",
    admin_filter_low_stock: "Showing: low / out of stock only",
    admin_amount_collected_label: "Amount collected (EGP)",
    admin_amount_collected_placeholder: "e.g. 2500",
    admin_amount_save_btn: "Save amount",
    admin_amount_saved: "Amount saved.",
    admin_amount_save_error: "Couldn't save the amount. Please try again.",
    admin_amount_collected_prompt: "How much was collected for this order? (EGP) — leave blank if you don't know yet.",
    admin_amount_order_total_suffix: "order total",
    admin_back_to_dashboard: "Dashboard",
    admin_settings_inventory: "Inventory",
    admin_settings_low_stock_threshold: "Low stock threshold",
    admin_settings_low_stock_note: "Pieces at or below this stock count get a low-stock badge. Set to 0 to turn the low-stock warnings off entirely.",
    admin_activity_title: "Activity Log",
    admin_activity_empty: "No activity yet.",
    admin_activity_filter_action: "Action",
    admin_activity_filter_actor: "Staff Member",
    admin_activity_filter_all_actions: "All Actions",
    admin_activity_filter_all_staff: "All Staff",
    admin_activity_filter_from: "From",
    admin_activity_filter_to: "To",
    admin_activity_filter_clear: "Clear Filters",
    admin_activity_restore: "Restore",
    admin_activity_delete: "Delete",
    admin_activity_restore_confirm: "Restore this item? It'll be added back exactly as it was.",
    ...
    admin_copy_shipping_btn: "Copy",
    admin_copy_shipping_success: "Shipping details copied!",
    admin_copy_generic_success: "Copied!",
    admin_copy_click_hint: "Click to copy",
    admin_copy_label_name: "Name",
    admin_copy_label_phone: "Phone",
    admin_copy_label_address: "Address",
    admin_copy_label_piece: "Piece",
    admin_copy_label_variant: "Size/Color",
    admin_copy_label_order: "Order #",
    ...
    admin_p_collection_label: "Collection",
    admin_p_collection_hint: "(optional, seasonal)",
    ...
    admin_p_availability: "Availability",
    admin_p_availability_made: "Made to Order — custom request",
    admin_p_availability_ready: "Ready to Ship — in stock now",
    admin_p_variants: "Available sizes & colors (in stock now)",
    admin_p_variants_note: "Leave size/color blank if this item doesn't come in variants — just set a stock count.",
    admin_p_variant_add: "+ Add size/color option",
    ...
    admin_cancel: "Cancel",
    admin_save: "Save",
    admin_my_profile: "✎ Edit My Profile",
    ...
    admin_staff_intro_html: "Type the email of someone who already has a client account on the site — we'll look it up and, if found, grant them dashboard access directly. If they don't have an account yet, ask them to sign up on the site first.",
    ...
    my_requests_multi_item: "Part of a {count}-item order",
    my_requests_group_label: "{count}-item order",
    my_account_title: "My Info",
    my_account_intro: "Edit your details here so they auto-fill in any new request.",
    my_account_save: "Save My Info",
    my_account_saved: "Saved.",
    my_account_error: "Couldn't save your info. Please try again.",
    ...
    detail_cta_order: "Order This Item",
    detail_back: "← Back",
    detail_img_prev: "Previous image",
    detail_img_next: "Next image",
    sale_badge: "Sale",
    ready_badge: "Ready to Ship",
    sold_out_label: "Sold Out",
    stock_left_label: "Only {count} left",
    in_cart_badge: "All in Your Cart",
    label_size: "Size",
    label_color: "Color",
    ...
    location_optional_note: "Optional: type your address, or use either option below — it doesn't need to match what's typed above.",
    pick_map_btn: "🗺️ Drop a pin on the map",
    map_pin_hint: "Tap the map or drag the pin to set your exact spot.",
