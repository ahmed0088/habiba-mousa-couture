...
const I18N = {
  ar: {
    ...
    admin_p_category_note: "نوع القطعة — زي فستان، عباية، بنطلون.",
    admin_p_collection_note: "تصنيف موسمي أو مناسبة اختياري — زي شتوي ٢٠٢٦، مجموعة رمضان — مش نوع القطعة.",
  ...
  en: {
    ...
    admin_p_category_note: "The type of garment — e.g. Dress, Abaya, Pants.",
    admin_p_collection_note: "An optional seasonal or themed grouping — e.g. Winter 2026, Ramadan Edit — not a garment type.",
